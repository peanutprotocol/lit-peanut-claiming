...
export const Generate = () => {
  ...
  const generate = async () => {
    ...
    const tokenContract = await new Contract(token, erc20ABI, signer);
    ...
    const factory = new Contract(config.vaultFactory, factoryABI, signer);
        ...
        >
          {loadingMessage ? (
            ...
            <>
              ...
              {res && (
                <HStack bgColor={"purple.300"} px={4} py={2} rounded={"lg"}>
